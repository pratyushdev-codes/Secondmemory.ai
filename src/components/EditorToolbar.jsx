    ...
    <div className="flex items-center justify-between px-4 py-3 glass-container bg-[#171717] border-b border-gray-800/50">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 py-1.5 px-3 bg-[#0A0A0A] rounded-full">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="24px" fill="#D9D9D9">
        ...
        <button
          onClick={() => window.open("https://intelsy.onrender.com/", "_blank")}
          className="flex items-center gap-2 text-white border px-3 py-0.5 rounded-full border-gray-700 hover:bg-gray-800/50 transition-colors duration-200"
        >
          <img src="/images/Intelsycompiler.png" alt="Intelsy Compiler" className="w-4 h-4" />
